...
const submissionSchema = new mongoose.Schema({
  ...
  evaluation: {
    ...
    approachRelevance: { type: Number, min: 0, max: 100, default: 0 },
    explanationCompleteness: { type: Number, min: 0, max: 100, default: 0 },
    ...
    mlPrediction: { type: Number, min: 0, max: 100, default: null },
  },
  // Timing
